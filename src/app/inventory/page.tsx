      ...
      <div className={styles.content}>
        ...
        <div>
          <div>
            ...
            полей в близлежащей среде. Используется для обнаружения признаков
            ЭМП
          </div>
          <div>
      ...
      <div className={styles.content}>
        ...
        <div>
          <div>
            ...
            среды. Включите и нажмите на кнопку измерения, через несколько
            секунд термометр покажет показания в градусах Цельсия (°C).
            Используется для обнаружения минусовой температуры.
          </div>
        </div>
      </div>
      <div className={styles.image}>
      ...
      <div className={styles.content}>
        ...
        <div>
          <div>
            ...
            Он создает белый шум, постоянно переключая различные радиочастоты,
            что позволяет некоторым призракам общаться с вами
          </div>
        </div>
      </div>
      <div className={styles.image}>
      ...
      <div className={styles.content}>
        ...
        <div>
          <div>
            ...
            позволяя игроку отслеживать потенциальную активность призраков.
            Датчик передаёт все звуки в наушники. Есть режим записи звуков.
          </div>
          <div>
            Датчик звука можно разместить на земле или другой плоской
            поверхности или держать в руках.
          </div>
          <div>
      ...
      <div className={styles.content}>
        ...
        <div>
          <div>
            ...
            полу. При установке датчик излучает красный лазерный луч, указывая
            на эффективное расстояние обнаружения. Когда кто или что-либо
            проходит через лазерный луч, датчик движения излучает яркий свет в
            течение 2 секунд и издаёт звуковой сигнал.
          </div>
          <div>
